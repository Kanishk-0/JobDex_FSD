...
namespace JobDex.Server.Migrations
{
    ...
    [Migration("20230210003925_addeddefault")]
            ...
            modelBuilder.Entity("JobDex.Shared.Domain.StaffDetails", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2023, 2, 10, 8, 39, 25, 201, DateTimeKind.Local).AddTicks(8559),
            ...
            modelBuilder.Entity("JobDex.Shared.Domain.UserDetails", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2023, 2, 10, 8, 39, 25, 200, DateTimeKind.Local).AddTicks(4230),
                            UserAddress = "punggol",
                            UserCStatus = "PR",
